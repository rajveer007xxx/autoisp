...
def verify_password(plain_password, hashed_password):
    """s40p: Never raise on a legacy/unknown hash format. Returning False
    causes the caller to surface a clean 'Invalid credentials' instead of
    HTTP 500 (which hangs the login spinner). Legitimate bcrypt hashes
    are unaffected."""
